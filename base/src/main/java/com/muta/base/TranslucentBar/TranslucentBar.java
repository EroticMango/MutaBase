...
import com.muta.base.util.FlymeOSStatusBarFontUtils;
import com.muta.base.util.KeyboardPatch;
import com.muta.base.util.OSUtils;
...
public class TranslucentBar {
     ...
     */
    private TranslucentBar(Fragment fragment) {
     ...
     */
    private TranslucentBar(Activity activity) {
     ...
     */
    public static TranslucentBar with(Activity activity) {
        return new TranslucentBar(activity);
    }
     ...
     * @return the immersion bar
     */
    public static TranslucentBar with(Fragment fragment) {
        return new TranslucentBar(fragment);
    }
     ...
     * @return the immersion bar
     */
    public TranslucentBar transparentStatusBar() {
     ...
     * @return the immersion bar
     */
    public TranslucentBar transparentNavigationBar() {
     ...
     * @return the immersion bar
     */
    public TranslucentBar transparentBar() {
        mBarParams.statusBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColorTemp = mBarParams.navigationBarColor;
        mBarParams.fullScreen = true;
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarColor(@ColorRes int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarColor(String statusBarColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarColorInt(@ColorInt int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar navigationBarColor(@ColorRes int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar navigationBarColor(String navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar navigationBarColorInt(@ColorInt int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColor(@ColorRes int barColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColor(@ColorRes int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColor(String barColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColor(String barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColorInt(@ColorInt int barColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColorInt(@ColorInt int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarColor = barColor;
        mBarParams.navigationBarColor = barColor;
        mBarParams.navigationBarColorTemp = mBarParams.navigationBarColor;
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarColorTransform(@ColorRes int statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarColorTransform(String statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarColorTransformInt(@ColorInt int statusBarColorTransform) {
        mBarParams.statusBarColorTransform = statusBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TranslucentBar navigationBarColorTransform(@ColorRes int navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar navigationBarColorTransform(String navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar navigationBarColorTransformInt(@ColorInt int navigationBarColorTransform) {
        mBarParams.navigationBarColorTransform = navigationBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColorTransform(@ColorRes int barColorTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColorTransform(String barColorTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar barColorTransformInt(@ColorInt int barColorTransform) {
        mBarParams.statusBarColorTransform = barColorTransform;
        mBarParams.navigationBarColorTransform = barColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TranslucentBar addViewSupportTransformColor(View view) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar addViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar addViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public TranslucentBar addViewSupportTransformColor(View view, String viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar addViewSupportTransformColor(View view, String viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public TranslucentBar addViewSupportTransformColorInt(View view, @ColorInt int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar addViewSupportTransformColorInt(View view, @ColorInt int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public TranslucentBar viewAlpha(@FloatRange(from = 0f, to = 1f) float viewAlpha) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar removeSupportView(View view) {
        if (view != null) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar removeSupportAllView() {
     ...
     * @return the immersion bar
     */
    public TranslucentBar fullScreen(boolean isFullScreen) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarAlpha(@FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar navigationBarAlpha(@FloatRange(from = 0f, to = 1f) float navigationAlpha) {
        mBarParams.navigationBarAlpha = navigationAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TranslucentBar barAlpha(@FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarAlpha = barAlpha;
        mBarParams.navigationBarAlpha = barAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarDarkFont(boolean isDarkFont) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarDarkFont(boolean isDarkFont, @FloatRange(from = 0f, to = 1f) float statusAlpha) {
        mBarParams.darkFont = isDarkFont;
        if (!isDarkFont)
            mBarParams.flymeOSStatusBarFontColor = 0;
        if (isSupportStatusBarDarkFont()) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar flymeOSStatusBarFontColor(@ColorRes int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar flymeOSStatusBarFontColor(String flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar flymeOSStatusBarFontColorInt(@ColorInt int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar hideBar(BarHide barHide) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar fitsSystemWindows(boolean fits) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarView(View view) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarView(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar statusBarView(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar supportActionBar(boolean isSupportActionBar) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar titleBar(View view) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar titleBar(View view, boolean statusBarFlag) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar titleBar(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar titleBar(@IdRes int viewId, View rootView, boolean statusBarFlag) {
     ...
     * @return the bar tag
     */
    public TranslucentBar addTag(String tag) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar getTag(String tag) {
        if (!isEmpty(tag)) {
     ...
     * @return the immersion bar
     */
    public TranslucentBar keyboardEnable(boolean enable) {
